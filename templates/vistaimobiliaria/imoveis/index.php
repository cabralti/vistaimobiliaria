    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                    <a class="btn btn-primary" href="<?= url('imoveis/criar') ?>">
        ...
        <table class="table table-striped data-table">
            ...
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td><?= $record['cidade'] ?></td>
                    <td><?= $record['bairro'] ?></td>
                    <td><?= $record['logradouro'] ?>, Nº <?= $record['numero'] ?></td>
                    <td>
                    ...
                    <td>
                        <a href="<?= url("imoveis/" . $record['id'] . "/editar") ?>"
                           class="btn btn-warning btn-sm">
                            <i class="fa fa-edit"></i> Editar
                        </a>
                        <button data-action="<?= url("imoveis/" . $record['id'] . "/excluir") ?>"
