    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
                <li class="nav-item">
                    <a class="btn btn-primary" href="<?= url('clientes/criar') ?>">
        ...
        <table class="table table-striped data-table">
            ...
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= url("clientes/" . $record['id'] . "/editar") ?>" class="btn btn-warning btn-sm">
                            <i class="fa fa-edit"></i> Editar
                        </a>
                        <button data-action="<?= url("clientes/" . $record['id'] . "/excluir") ?>"
