...
<div class="card">
    <div class="card-body">
        <form action="<?= url('proprietarios') ?>" method="post" class="form-create">
            ...
            <div class="form-group">
                ...
                <input type="number" name="dia_repasse" id="dia_repasse" class="form-control" placeholder="">
            </div>
            <div class="form-group">
