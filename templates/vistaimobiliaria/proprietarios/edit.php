        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= url('/proprietarios') ?>">Proprietários</a></li>
...
<div class="card">
    <div class="card-body">
        <form action="<?= url("proprietarios/" . $record['id'] . "/editar") ?>" method="post" class="form-edit">
            ...
            <div class="form-group">
                <label for="">Dia Repasse:</label>
                <input type="number" name="dia_repasse" id="dia_repasse" class="form-control"
                       value="<?= $record['dia_repasse'] ?>">
            </div>
            <div class=" form-group">
                <button type="submit" class="btn btn-success" title="Salvar Dados"><i class="fa fa-save"></i> Salvar
                </button>
                <a href="<?= url('proprietarios') ?>" class="btn btn-default" title="Cancelar edição"> Cancelar</a>
            </div>
        </form>
    </div>
    <!-- /.card-body -->
